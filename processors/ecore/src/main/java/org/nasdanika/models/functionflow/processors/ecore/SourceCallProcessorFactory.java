...
public class SourceCallProcessorFactory extends CallProcessorFactory {
	...
	@EClassifierNodeProcessorFactory(
			label = "Source Call",
			description = "Call with source code",
			documentation = 
                    """
					Source call executes its source to transform input to target input and then target output to output.
                    """
	)
	public EClassNodeProcessor createSourceTransitionProcessor(

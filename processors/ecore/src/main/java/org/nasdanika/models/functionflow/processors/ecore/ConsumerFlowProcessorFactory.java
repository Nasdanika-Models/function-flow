...
public class ConsumerFlowProcessorFactory extends FlowProcessorFactory {
	...
	@EClassifierNodeProcessorFactory(
			label = "Consumer Flow",
			description = "Composite consumer",
			documentation = 
                    """
					Consumer flow passes its inputs to a matching [Start](../Start/index.html).
                    """
	)
	public EClassNodeProcessor createConsumerFlowProcessor(

 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.functionflow.impl.FunctionFlowImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.nasdanika.models.functionflow.impl.FunctionFlowImpl#getActors <em>Actors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionFlowImpl extends FunctionImpl implements FunctionFlow {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public EList<ArchitectureDescriptionElement> getElements() {
		return (EList<ArchitectureDescriptionElement>)eDynamicGet(FunctionFlowPackage.FUNCTION_FLOW__ELEMENTS, ModelPackage.Literals.GRAPH__ELEMENTS, true, true);
	}
	...
	public EList<Actor> getActors() {
		return (EList<Actor>)eDynamicGet(FunctionFlowPackage.FUNCTION_FLOW__ACTORS, ArchitecturePackage.Literals.ARCHITECTURE_DESCRIPTION__ACTORS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionFlowPackage.FUNCTION_FLOW__ELEMENTS:
				return ((InternalEList<?>)getElements()).basicRemove(otherEnd, msgs);
			case FunctionFlowPackage.FUNCTION_FLOW__ACTORS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Graph.class) {
			switch (derivedFeatureID) {
				case FunctionFlowPackage.FUNCTION_FLOW__ELEMENTS: return ModelPackage.GRAPH__ELEMENTS;
				default: return -1;
			}
		}
		...
		if (baseClass == ArchitectureDescription.class) {
			switch (derivedFeatureID) {
				case FunctionFlowPackage.FUNCTION_FLOW__ACTORS: return ArchitecturePackage.ARCHITECTURE_DESCRIPTION__ACTORS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Graph.class) {
			switch (baseFeatureID) {
				case ModelPackage.GRAPH__ELEMENTS: return FunctionFlowPackage.FUNCTION_FLOW__ELEMENTS;
				default: return -1;
			}
		}
		if (baseClass == DocumentedNamedGraph.class) {
		...
		if (baseClass == ArchitectureDescription.class) {
			switch (baseFeatureID) {
				case ArchitecturePackage.ARCHITECTURE_DESCRIPTION__ACTORS: return FunctionFlowPackage.FUNCTION_FLOW__ACTORS;
				default: return -1;
			}
		}
		if (baseClass == Domain.class) {

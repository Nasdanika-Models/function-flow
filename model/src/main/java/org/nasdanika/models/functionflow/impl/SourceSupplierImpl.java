 ...
 *   <li>{@link org.nasdanika.models.functionflow.impl.SourceSupplierImpl#getBaseURI <em>Base URI</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SourceSupplierImpl extends SupplierImpl implements SourceSupplier {
	...
	public String getBaseURI() {
		return (String)eDynamicGet(FunctionFlowPackage.SOURCE_SUPPLIER__BASE_URI, FunctionFlowPackage.Literals.SOURCE__BASE_URI, true, true);
	}
	...
	public void setBaseURI(String newBaseURI) {
		eDynamicSet(FunctionFlowPackage.SOURCE_SUPPLIER__BASE_URI, FunctionFlowPackage.Literals.SOURCE__BASE_URI, newBaseURI);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionFlowPackage.SOURCE_SUPPLIER__SOURCE:
				return getSource();
			case FunctionFlowPackage.SOURCE_SUPPLIER__BASE_URI:
				return getBaseURI();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Source.class) {
			switch (derivedFeatureID) {
				...
				case FunctionFlowPackage.SOURCE_SUPPLIER__BASE_URI: return FunctionFlowPackage.SOURCE__BASE_URI;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Source.class) {
			switch (baseFeatureID) {
				...
				case FunctionFlowPackage.SOURCE__BASE_URI: return FunctionFlowPackage.SOURCE_SUPPLIER__BASE_URI;
				default: return -1;
			}
		}
